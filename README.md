...
## Deployment
GitHub Pages deployment is intentionally pending repository-owner setup. After Pages is enabled, verify the deployment path and keep production builds compatible with static hosting.
